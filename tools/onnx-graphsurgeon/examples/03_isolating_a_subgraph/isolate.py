...
# shape and type information in the graph. We can use ONNX shape inference to do this:
#
# from onnx import shape_inference
# model = shape_inference.infer_shapes(onnx.load("model.onnx"))
#
# IMPORTANT: In some cases, ONNX shape inference may not correctly infer shapes/types,
# which will result in an invalid subgraph. To avoid this, you can instead modify
# the tensors to include the shape/type information yourself.
...
# If you want to embed shape/type information, but cannot use ONNX shape inference,
...
graph.inputs = [tensors["x1"]]
graph.outputs = [tensors["add_out"]]
