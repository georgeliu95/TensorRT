...
static constexpr int32_t NV_TENSORRT_VERSION
...
public:
    ...
    PluginField(AsciiChar const* name_ = nullptr, void const* data_ = nullptr, PluginFieldType const type_ = PluginFieldType::kUNKNOWN, int32_t length_ = 0) noexcept
        : name(name_)
        , data(data_)
        , type(type_)
        , length(length_)
