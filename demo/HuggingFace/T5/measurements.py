...
# TRT-HuggingFace
from general_utils import measure_python_inference_code, use_cuda
...
@use_cuda
def full_inference_greedy(t5_encoder, t5_decoder, input_ids, tokenizer, timing_profile, max_length, use_cuda=True):
...
def full_inference_beam(
    t5_encoder, t5_decoder, input_ids, tokenizer, num_beams, timing_profile, use_cuda=True
):
