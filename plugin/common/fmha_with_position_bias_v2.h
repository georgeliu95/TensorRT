...
public:
    ...
    TFusedMultiHeadAttentionXMMAKernel(TKernelMeta const* pMetaStart, int32_t nMetaCount, MHADataType type, int32_t sm)
        : mDataType(type)
...
public:
    FusedMultiHeadAttentionXMMAKernelV2(
        FusedMHAKernelMetaInfo const* pMetaStart, int32_t nMetaCount, MHADataType type, int32_t sm)
...
public:
    TFusedMHAKernelList const* getXMMAKernels(
        typename TFusedMHAKernelList::KernelMeta const* pKernelList, int32_t nbKernels, MHADataType type, int32_t sm)
    {
...
private:
    ...
    uint64_t hashID(MHADataType type, int32_t sm) const
    {
...
inline FusedMultiHeadAttentionXMMAKernelV2 const* getXMMAKernelsV2(MHADataType type, int32_t sm)
{
