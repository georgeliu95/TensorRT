...
namespace
{
const char* INSTNORM3D_PLUGIN_VERSION{"2"};
const char* INSTNORM3D_PLUGIN_NAME{"InstanceNormalization_TRT"};
} // namespace
...
int32_t InstanceNormalization3DPlugin::getNbOutputs() const noexcept
{
    return 1;
}

DimsExprs InstanceNormalization3DPlugin::getOutputDimensions(int32_t outputIndex, const nvinfer1::DimsExprs* inputs,
...
int32_t InstanceNormalization3DPlugin::initialize() noexcept
{
    if (!initialized)
    {
...
void InstanceNormalization3DPlugin::terminate() noexcept
{
    if (initialized)
    {
...
size_t InstanceNormalization3DPlugin::getWorkspaceSize(const nvinfer1::PluginTensorDesc* inputs, int32_t nbInputs,
...
int32_t InstanceNormalization3DPlugin::enqueue(const nvinfer1::PluginTensorDesc* inputDesc,
    ...
    cudaStream_t stream) noexcept
{
    ...
    if (inputDesc[0].format == nvinfer1::PluginFormat::kLINEAR)
    {
        ...
        int32_t nc_strideA[] = {nc_dimA[1] * nc_dimA[2] * nc_dimA[3] * nc_dimA[4], nc_dimA[2] * nc_dimA[3] * nc_dimA[4],
        ...
        CHECK_CUDNN(cudnnBatchNormalizationForwardTraining(_cudnn_handle, CUDNN_BATCHNORM_SPATIAL_PERSISTENT, &alpha,
            &beta, _x_desc, x_ptr, _y_desc, y_ptr, _b_desc, d_scale, d_bias, 1., nullptr, nullptr, _epsilon, nullptr,
            nullptr));
        ...
        || inputDesc[0].format == nvinfer1::PluginFormat::kCDHW32)
    {
        ...
        int32_t loop = instance_norm_fwd_dispatch(_context, _params, stream, input_data_type, output_data_type);
    }
    else
    {
...
size_t InstanceNormalization3DPlugin::getSerializationSize() const noexcept
{
...
void InstanceNormalization3DPlugin::serialize(void* buffer) const noexcept
{
...
const char* InstanceNormalization3DPlugin::getPluginType() const noexcept
{
    return INSTNORM3D_PLUGIN_NAME;
}

const char* InstanceNormalization3DPlugin::getPluginVersion() const noexcept
{
    return INSTNORM3D_PLUGIN_VERSION;
}

void InstanceNormalization3DPlugin::destroy() noexcept
{
    delete this;
}

IPluginV2DynamicExt* InstanceNormalization3DPlugin::clone() const noexcept
{
...
void InstanceNormalization3DPlugin::setPluginNamespace(const char* pluginNamespace) noexcept
{
    mPluginNamespace = pluginNamespace;
}

const char* InstanceNormalization3DPlugin::getPluginNamespace() const noexcept
{
...
void InstanceNormalization3DPlugin::configurePlugin(const nvinfer1::DynamicPluginTensorDesc* in, int32_t nbInputs,
...
const char* InstanceNormalization3DPluginCreator::getPluginName() const noexcept
{
    return INSTNORM3D_PLUGIN_NAME;
}

const char* InstanceNormalization3DPluginCreator::getPluginVersion() const noexcept
{
    return INSTNORM3D_PLUGIN_VERSION;
}

const PluginFieldCollection* InstanceNormalization3DPluginCreator::getFieldNames() noexcept
{
    return &mFC;
}

IPluginV2DynamicExt* InstanceNormalization3DPluginCreator::createPlugin(
    const char* name, const nvinfer1::PluginFieldCollection* fc) noexcept
{
    ...
    InstanceNormalization3DPlugin* obj
        = new InstanceNormalization3DPlugin(epsilon, scaleWeights, biasWeights, relu, alpha);
    obj->setPluginNamespace(mNamespace.c_str());
    obj->initialize();
    return obj;
}

IPluginV2DynamicExt* InstanceNormalization3DPluginCreator::deserializePlugin(
