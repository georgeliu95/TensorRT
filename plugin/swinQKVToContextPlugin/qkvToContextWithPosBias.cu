...
#include "common/fmha_with_position_bias_v2.h"
...
static inline void setAlpha(uint32_t& alpha, float norm, MHADataType dtype)
{
...
public:
    ...
    void setup(int32_t const S, int32_t const B, int32_t const windowNum)
    {
        ...
        MHADataType scaleType = DATA_TYPE_FP16;
