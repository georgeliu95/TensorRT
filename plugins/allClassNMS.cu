...
typedef ssdStatus_t (*nmsFunc)(cudaStream_t,
                               const int,
                               const int,
                               const int,
                               const int,
...
struct nmsLaunchConfigSSD
{
    ...
    nmsLaunchConfigSSD(DType_t t_score, DType_t t_bbox)
        : t_score(t_score)
        , t_bbox(t_bbox)
    {
    }
    nmsLaunchConfigSSD(DType_t t_score, DType_t t_bbox, nmsFunc function)
        : t_score(t_score)
        , t_bbox(t_bbox)
        , function(function)
    {
