...
int LReLU::getNbOutputs() const { return 1; }
...
void LReLU::configureWithFormat(const Dims* inputDims, int nbInputs,
...
int LReLU::initialize() { return 0; }

void LReLU::terminate() {}

size_t LReLU::getWorkspaceSize(int maxBatchSize) const { return 0; }

const char* LReLU::getPluginType() const { return LRELU_PLUGIN_NAME; }

const char* LReLU::getPluginVersion() const { return LRELU_PLUGIN_VERSION; }

void LReLU::destroy() { delete this; }
