...
parser.add_argument('--width', required=True, help='Input directory')
parser.add_argument('--height', required=True, help='Input directory')
...
if HEIGHT == 416 and WIDTH == 416 :
    outDir  = args.outDir+"/batchesV2"
elif HEIGHT == 544 and WIDTH == 544 :
    outDir  = args.outDir+"/batches9000"
else:
    print("Please provide correct values for width and height.\nFor YOLO v2 network height = 416 & width = 416.\nFor YOLO9000 network height = 544 & width = 544\n")
    exit()
...
for i in range(NUM_CALIBRATION_IMAGES):
    os.system("convert "+imgs[i]+" -resize "+str(WIDTH)+"x"+str(HEIGHT)+"! "+outDir+"/"+str(i)+".ppm")
...
for i in range(NUM_BATCHES):
	...
	in_ *= np.array((1/255.0, 1/255.0,1/255.0))
